...
function initCarousel() {
	$('div.main-gallery').scrollGallery({
		mask: 'div.mask',
		slider: '>ul',
		slides: '>li',
	...
	$('div.small-gallery').scrollGallery({
		mask: 'div.mask',
		slider: '>ul',
		slides: '>li',
		btnPrev: 'a.prev',
