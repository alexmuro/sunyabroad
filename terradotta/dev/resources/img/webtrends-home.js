...
// Created: 8/27/2012 3:45:33 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsnv5h1e10000shwesexznq7_4e3k";
	this.domain="sdc.albany.edu";
	this.timezone=-5;
	this.onsitedoms="";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,docx,xlsx,ppt,pptx";
